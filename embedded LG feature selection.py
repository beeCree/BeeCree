...
application_train = pd.read_csv('Book1.csv') ##data_train.csv이어야 하지만 테스트용
...
##feature selection with embedded Logistic regression
print("feature selecting...")
X = pd.DataFrame(total_data_df)
X_norm = MinMaxScaler().fit_transform(X)

embeded_lr_selector = SelectFromModel(LogisticRegression(penalty="l1"), '1.05*median')
...
print(embeded_lr_selector.get_support(indices = True))
...
"""
"""
clf = SelectFromModel(LogisticRegression(penalty="l1"), '1.25*median')
